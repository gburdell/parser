...
tryAgain:
	...
	protected final void mTIC_LINE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if ((_tokenSet_2.member(LA(1)))) {
				...
				if ( _cnt1566>=1 ) { break _loop1566; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
	...
	public final void mSYSTEM_TF_IDENTIFIER(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
			{
				if ( _cnt1585>=1 ) { break _loop1585; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
			}
			_cnt1585++;
		} while (true);
	...
	protected final void mNUMBER(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		if (((_tokenSet_5.member(LA(1))) && (_tokenSet_6.member(LA(2))) && (_tokenSet_7.member(LA(3))) && (true))) {
			...
			try {
				...
				synPredMatched1589 = false;
			}
			rewind(_m1589);
inputState.guessing--;
		}
		if ( synPredMatched1589 ) {
			mSIZED_NUMBER(false);
		}
	...
	protected final void mEXPONENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt1627>=1 ) { break _loop1627; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
			}
